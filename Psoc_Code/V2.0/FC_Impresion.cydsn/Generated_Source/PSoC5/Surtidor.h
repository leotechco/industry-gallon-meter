...
#define Surtidor_RX_BUFFER_SIZE                 (255u)
...
extern uint8 Surtidor_initVar;
    ...
    extern volatile uint8 Surtidor_rxBufferRead;
    extern volatile uint8 Surtidor_rxBufferWrite;
