...
*
* \funcusage
*  \snippet IB1_SUT.c usage_IB1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet IB1_SUT.c usage_IB1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet IB1_SUT.c usage_IB1_Read  
*******************************************************************************/
uint8 IB1_Read(void)
{
...
* preferred IB1_Read() API because the 
* IB1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet IB1_SUT.c usage_IB1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: IB1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use IB1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - IB1_0_INTR       (First pin in the list)
    *  - IB1_1_INTR       (Second pin in the list)
    *  - ...
    *  - IB1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet IB1_SUT.c usage_IB1_SetInterruptMode
    *******************************************************************************/
    void IB1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & IB1_0_INTR) != 0u) 
		{ 
			 IB1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet IB1_SUT.c usage_IB1_ClearInterrupt
    *******************************************************************************/
