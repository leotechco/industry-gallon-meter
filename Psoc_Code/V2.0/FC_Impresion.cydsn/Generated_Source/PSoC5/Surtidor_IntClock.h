...
#define Surtidor_IntClock_SetDivider(clkDivider)         Surtidor_IntClock_SetDividerRegister(clkDivider, 1u)
#define Surtidor_IntClock_SetDividerValue(clkDivider)    Surtidor_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define Surtidor_IntClock_SetPhaseValue(clkPhase)        Surtidor_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(Surtidor_IntClock__CFG3) */
