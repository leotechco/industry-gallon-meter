// ======================================================================
// FC_Impresion.v generated from TopDesign.cysch
// 08/08/2018 at 12:12
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=115200, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=921600, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=PSOC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PSOC, CY_INSTANCE_SHORT_NAME=PSOC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PSOC, )
module UART_v2_50_2 (
    cts_n,
    tx,
    rts_n,
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=1, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=false, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=50, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=Bluetooth, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Bluetooth, CY_INSTANCE_SHORT_NAME=Bluetooth, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Bluetooth, )
module UART_v2_50_3 (
    cts_n,
    tx,
    rts_n,
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=4800, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=1, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=false, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=38400, RXAddressMode=0, RXBufferSize=255, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONFIG_TITLE=Surtidor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Surtidor, CY_INSTANCE_SHORT_NAME=Surtidor, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Surtidor, )
module UART_v2_50_4 (
    cts_n,
    tx,
    rts_n,
...
module top ;
    ...
    UART_v2_50_0 RS232 (
        ...
        .rx_data(Net_86),
        .rx_clk(Net_87));
    defparam RS232.Address1 = 0;
    defparam RS232.Address2 = 0;
    defparam RS232.EnIntRXInterrupt = 1;
    defparam RS232.EnIntTXInterrupt = 0;
    defparam RS232.FlowControl = 0;
    defparam RS232.HalfDuplexEn = 0;
    defparam RS232.HwTXEnSignal = 1;
    defparam RS232.NumDataBits = 8;
    defparam RS232.NumStopBits = 1;
    defparam RS232.ParityType = 0;
    defparam RS232.RXEnable = 1;
    defparam RS232.TXEnable = 1;

	wire [0:0] tmpOE__Rx_RS232_net;
	wire [0:0] tmpIO_0__Rx_RS232_net;
	wire [0:0] tmpINTERRUPT_0__Rx_RS232_net;
	electrical [0:0] tmpSIOVREF__Rx_RS232_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_RS232
		 (.oe(tmpOE__Rx_RS232_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__Rx_RS232_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_RS232_net),
		  .interrupt({tmpINTERRUPT_0__Rx_RS232_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_RS232_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_RS232_net;
	wire [0:0] tmpFB_0__Tx_RS232_net;
	wire [0:0] tmpIO_0__Tx_RS232_net;
	wire [0:0] tmpINTERRUPT_0__Tx_RS232_net;
	electrical [0:0] tmpSIOVREF__Tx_RS232_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_RS232
		 (.oe(tmpOE__Tx_RS232_net),
		  .y({Net_47}),
		  .fb({tmpFB_0__Tx_RS232_net[0:0]}),
		  .io({tmpIO_0__Tx_RS232_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_RS232_net),
		  .interrupt({tmpINTERRUPT_0__Tx_RS232_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_RS232_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_1 RFID (
        ...
        .rx_data(Net_99),
        .rx_clk(Net_100));
    defparam RFID.Address1 = 0;
    defparam RFID.Address2 = 0;
    defparam RFID.EnIntRXInterrupt = 0;
    defparam RFID.EnIntTXInterrupt = 0;
    defparam RFID.FlowControl = 0;
    defparam RFID.HalfDuplexEn = 0;
    defparam RFID.HwTXEnSignal = 1;
    defparam RFID.NumDataBits = 8;
    defparam RFID.NumStopBits = 1;
    defparam RFID.ParityType = 0;
    defparam RFID.RXEnable = 1;
    defparam RFID.TXEnable = 1;

	wire [0:0] tmpOE__Rx_RFID_net;
	wire [0:0] tmpIO_0__Rx_RFID_net;
	wire [0:0] tmpINTERRUPT_0__Rx_RFID_net;
	electrical [0:0] tmpSIOVREF__Rx_RFID_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e41a3771-79ad-4caf-b208-8a450f7e0e96"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_RFID
		 (.oe(tmpOE__Rx_RFID_net),
		  .y({1'b0}),
		  .fb({Net_94}),
		  .io({tmpIO_0__Rx_RFID_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_RFID_net),
		  .interrupt({tmpINTERRUPT_0__Rx_RFID_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_RFID_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_RFID_net;
	wire [0:0] tmpFB_0__Tx_RFID_net;
	wire [0:0] tmpIO_0__Tx_RFID_net;
	wire [0:0] tmpINTERRUPT_0__Tx_RFID_net;
	electrical [0:0] tmpSIOVREF__Tx_RFID_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("101b821f-92d3-44ae-9ffc-d36bddd3461b"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_RFID
		 (.oe(tmpOE__Tx_RFID_net),
		  .y({Net_89}),
		  .fb({tmpFB_0__Tx_RFID_net[0:0]}),
		  .io({tmpIO_0__Tx_RFID_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_RFID_net),
		  .interrupt({tmpINTERRUPT_0__Tx_RFID_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_RFID_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_2 PSOC (
        ...
        .rx_data(Net_112),
        .rx_clk(Net_113));
    defparam PSOC.Address1 = 0;
    defparam PSOC.Address2 = 0;
    defparam PSOC.EnIntRXInterrupt = 0;
    defparam PSOC.EnIntTXInterrupt = 0;
    defparam PSOC.FlowControl = 0;
    defparam PSOC.HalfDuplexEn = 0;
    defparam PSOC.HwTXEnSignal = 1;
    defparam PSOC.NumDataBits = 8;
    defparam PSOC.NumStopBits = 1;
    defparam PSOC.ParityType = 0;
    defparam PSOC.RXEnable = 1;
    defparam PSOC.TXEnable = 1;

	wire [0:0] tmpOE__Rx_PSOC_net;
	wire [0:0] tmpIO_0__Rx_PSOC_net;
	wire [0:0] tmpINTERRUPT_0__Rx_PSOC_net;
	electrical [0:0] tmpSIOVREF__Rx_PSOC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe79113d-be72-4313-bc2c-802291e81e16"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_PSOC
		 (.oe(tmpOE__Rx_PSOC_net),
		  .y({1'b0}),
		  .fb({Net_107}),
		  .io({tmpIO_0__Rx_PSOC_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_PSOC_net),
		  .interrupt({tmpINTERRUPT_0__Rx_PSOC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_PSOC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_PSOC_net;
	wire [0:0] tmpFB_0__Tx_PSOC_net;
	wire [0:0] tmpIO_0__Tx_PSOC_net;
	wire [0:0] tmpINTERRUPT_0__Tx_PSOC_net;
	electrical [0:0] tmpSIOVREF__Tx_PSOC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1b224573-4080-491b-a02c-9bcdbab8b784"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_PSOC
		 (.oe(tmpOE__Tx_PSOC_net),
		  .y({Net_102}),
		  .fb({tmpFB_0__Tx_PSOC_net[0:0]}),
		  .io({tmpIO_0__Tx_PSOC_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_PSOC_net),
		  .interrupt({tmpINTERRUPT_0__Tx_PSOC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_PSOC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_3 Bluetooth (
        .cts_n(1'b0),
        .tx(Net_115),
        .rts_n(Net_116),
        .tx_en(Net_117),
        ...
        .rx_data(Net_125),
        .rx_clk(Net_126));
    defparam Bluetooth.Address1 = 0;
    defparam Bluetooth.Address2 = 0;
    defparam Bluetooth.EnIntRXInterrupt = 1;
    defparam Bluetooth.EnIntTXInterrupt = 0;
    defparam Bluetooth.FlowControl = 0;
    defparam Bluetooth.HalfDuplexEn = 0;
    defparam Bluetooth.HwTXEnSignal = 0;
    defparam Bluetooth.NumDataBits = 8;
    defparam Bluetooth.NumStopBits = 1;
    defparam Bluetooth.ParityType = 0;
    defparam Bluetooth.RXEnable = 1;
    defparam Bluetooth.TXEnable = 1;

	wire [0:0] tmpOE__Rx_Blue_net;
	wire [0:0] tmpIO_0__Rx_Blue_net;
	wire [0:0] tmpINTERRUPT_0__Rx_Blue_net;
	electrical [0:0] tmpSIOVREF__Rx_Blue_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("354530a4-c985-4b47-b5ed-c80054612bdd"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_Blue
		 (.oe(tmpOE__Rx_Blue_net),
		  .y({1'b0}),
		  .fb({Net_120}),
		  .io({tmpIO_0__Rx_Blue_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_Blue_net),
		  .interrupt({tmpINTERRUPT_0__Rx_Blue_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_Blue_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_Blue_net;
	wire [0:0] tmpFB_0__Tx_Blue_net;
	wire [0:0] tmpIO_0__Tx_Blue_net;
	wire [0:0] tmpINTERRUPT_0__Tx_Blue_net;
	electrical [0:0] tmpSIOVREF__Tx_Blue_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8e28cdc5-fb91-47ad-a494-3ff1981c8008"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_Blue
		 (.oe(tmpOE__Tx_Blue_net),
		  .y({Net_115}),
		  .fb({tmpFB_0__Tx_Blue_net[0:0]}),
		  .io({tmpIO_0__Tx_Blue_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_Blue_net),
		  .interrupt({tmpINTERRUPT_0__Tx_Blue_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_Blue_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_4 Surtidor (
        .cts_n(1'b0),
        .tx(Net_128),
        .rts_n(Net_129),
        .tx_en(Net_130),
        ...
        .reset(1'b0),
        .rx(Net_133),
        .tx_interrupt(Net_134),
        .rx_interrupt(Net_135),
        .tx_data(Net_136),
        .tx_clk(Net_137),
        .rx_data(Net_138),
        .rx_clk(Net_139));
    ...
    defparam Surtidor.ParityType = 0;
    defparam Surtidor.RXEnable = 1;
    defparam Surtidor.TXEnable = 1;

	wire [0:0] tmpOE__Rx_Surt_net;
	wire [0:0] tmpIO_0__Rx_Surt_net;
	wire [0:0] tmpINTERRUPT_0__Rx_Surt_net;
	electrical [0:0] tmpSIOVREF__Rx_Surt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c727e592-00fb-44ef-95fd-7cd86c611fb8"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_Surt
		 (.oe(tmpOE__Rx_Surt_net),
		  .y({1'b0}),
		  .fb({Net_133}),
		  .io({tmpIO_0__Rx_Surt_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_Surt_net),
		  .interrupt({tmpINTERRUPT_0__Rx_Surt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_Surt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Tx_Surt_net;
	wire [0:0] tmpFB_0__Tx_Surt_net;
	wire [0:0] tmpIO_0__Tx_Surt_net;
	wire [0:0] tmpINTERRUPT_0__Tx_Surt_net;
	electrical [0:0] tmpSIOVREF__Tx_Surt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e460c365-2ae6-4689-8b60-6540d166f1a7"),
		  ...
		  .input_buffer_sel(2'b00))
		Tx_Surt
		 (.oe(tmpOE__Tx_Surt_net),
		  .y({Net_128}),
		  .fb({tmpFB_0__Tx_Surt_net[0:0]}),
		  .io({tmpIO_0__Tx_Surt_net[0:0]}),
		  .siovref(tmpSIOVREF__Tx_Surt_net),
		  .interrupt({tmpINTERRUPT_0__Tx_Surt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Tx_Surt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Select1_RFID_net;
	wire [0:0] tmpFB_0__Select1_RFID_net;
	wire [0:0] tmpIO_0__Select1_RFID_net;
	wire [0:0] tmpINTERRUPT_0__Select1_RFID_net;
	electrical [0:0] tmpSIOVREF__Select1_RFID_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ba717816-e935-4e30-8c9a-045aa73f19ee"),
		  ...
		  .input_buffer_sel(2'b00))
		Select1_RFID
		 (.oe(tmpOE__Select1_RFID_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Select1_RFID_net[0:0]}),
		  .io({tmpIO_0__Select1_RFID_net[0:0]}),
		  .siovref(tmpSIOVREF__Select1_RFID_net),
		  .interrupt({tmpINTERRUPT_0__Select1_RFID_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Select1_RFID_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Enable_RFid_net;
	wire [0:0] tmpFB_0__Enable_RFid_net;
	wire [0:0] tmpIO_0__Enable_RFid_net;
	wire [0:0] tmpINTERRUPT_0__Enable_RFid_net;
	electrical [0:0] tmpSIOVREF__Enable_RFid_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("30f3ae93-bede-4ca9-8027-55a066a69c20"),
		  ...
		  .input_buffer_sel(2'b00))
		Enable_RFid
		 (.oe(tmpOE__Enable_RFid_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Enable_RFid_net[0:0]}),
		  .io({tmpIO_0__Enable_RFid_net[0:0]}),
		  .siovref(tmpSIOVREF__Enable_RFid_net),
		  .interrupt({tmpINTERRUPT_0__Enable_RFid_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enable_RFid_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Select1_RS232_net;
	wire [0:0] tmpFB_0__Select1_RS232_net;
	wire [0:0] tmpIO_0__Select1_RS232_net;
	wire [0:0] tmpINTERRUPT_0__Select1_RS232_net;
	electrical [0:0] tmpSIOVREF__Select1_RS232_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9d1731f0-f13d-47a0-8da1-de17a109e2b6"),
		  ...
		  .input_buffer_sel(2'b00))
		Select1_RS232
		 (.oe(tmpOE__Select1_RS232_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Select1_RS232_net[0:0]}),
		  .io({tmpIO_0__Select1_RS232_net[0:0]}),
		  .siovref(tmpSIOVREF__Select1_RS232_net),
		  .interrupt({tmpINTERRUPT_0__Select1_RS232_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Select1_RS232_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Select0_RFID_net;
	wire [0:0] tmpFB_0__Select0_RFID_net;
	wire [0:0] tmpIO_0__Select0_RFID_net;
	wire [0:0] tmpINTERRUPT_0__Select0_RFID_net;
	electrical [0:0] tmpSIOVREF__Select0_RFID_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b475d6d9-5050-46cd-8c46-d6909517dcce"),
		  ...
		  .input_buffer_sel(2'b00))
		Select0_RFID
		 (.oe(tmpOE__Select0_RFID_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Select0_RFID_net[0:0]}),
		  .io({tmpIO_0__Select0_RFID_net[0:0]}),
		  .siovref(tmpSIOVREF__Select0_RFID_net),
		  .interrupt({tmpINTERRUPT_0__Select0_RFID_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Select0_RFID_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Select0_RS232_net;
	wire [0:0] tmpFB_0__Select0_RS232_net;
	wire [0:0] tmpIO_0__Select0_RS232_net;
	wire [0:0] tmpINTERRUPT_0__Select0_RS232_net;
	electrical [0:0] tmpSIOVREF__Select0_RS232_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Select0_RS232
		 (.oe(tmpOE__Select0_RS232_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Select0_RS232_net[0:0]}),
		  .io({tmpIO_0__Select0_RS232_net[0:0]}),
		  .siovref(tmpSIOVREF__Select0_RS232_net),
		  .interrupt({tmpINTERRUPT_0__Select0_RS232_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Select0_RS232_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [1:0] tmpOE__Botones_net;
	wire [1:0] tmpFB_1__Botones_net;
	...
	wire [1:0] tmpOE__Psoc_status_net;
	wire [1:0] tmpFB_1__Psoc_status_net;
	wire [1:0] tmpIO_1__Psoc_status_net;
	wire [0:0] tmpINTERRUPT_0__Psoc_status_net;
	electrical [0:0] tmpSIOVREF__Psoc_status_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6e63a25a-5695-40a6-b2b0-1e61c633804c"),
		  ...
		  .input_buffer_sel(4'b00_00))
		Psoc_status
		 (.oe(tmpOE__Psoc_status_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__Psoc_status_net[1:0]}),
		  .io({tmpIO_1__Psoc_status_net[1:0]}),
		  .siovref(tmpSIOVREF__Psoc_status_net),
		  .interrupt({tmpINTERRUPT_0__Psoc_status_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Psoc_status_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
