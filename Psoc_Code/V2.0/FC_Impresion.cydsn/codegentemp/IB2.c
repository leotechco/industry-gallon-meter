...
*
* \funcusage
*  \snippet IB2_SUT.c usage_IB2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet IB2_SUT.c usage_IB2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet IB2_SUT.c usage_IB2_Read  
*******************************************************************************/
uint8 IB2_Read(void)
{
...
* preferred IB2_Read() API because the 
* IB2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet IB2_SUT.c usage_IB2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: IB2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use IB2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - IB2_0_INTR       (First pin in the list)
    *  - IB2_1_INTR       (Second pin in the list)
    *  - ...
    *  - IB2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet IB2_SUT.c usage_IB2_SetInterruptMode
    *******************************************************************************/
    void IB2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & IB2_0_INTR) != 0u) 
		{ 
			 IB2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet IB2_SUT.c usage_IB2_ClearInterrupt
    *******************************************************************************/
